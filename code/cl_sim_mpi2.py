...
def main():
    ...
    noise_maps_sim, nhits = cl_lib.noise_maps_simulation(
    ...
    if map_creation:
        ...
        start_map = time.time()
        Cl_dust, Cl_sync, dust_map_freq, sync_map_freq = cl_lib.get_foreground_maps_and_cl(
        ...
        Cl_noise = cl_lib.get_nsim_freq_cl_mpi(mask*noise_maps, nsim, frequencies_index, mask,
    ...
    error68_EEBBEB = cl_lib.grid_error(spectra_cl, data_model_matrix,
    ...
    error68_EE = cl_lib.grid_error(spectra_cl, data_model_matrix_EE,
    ...
    alpha_grid_fisherBB = np.arange(min_angle, max_angle,
                                    (max_angle - min_angle)/nstep_angle)
    error68_BB = cl_lib.grid_error(spectra_cl, data_model_matrix_BB,
    ...
    alpha_grid_fisherEB = np.arange(min_angle, max_angle,
                                    (max_angle - min_angle)/nstep_angle)
    error68_EB = cl_lib.grid_error(spectra_cl, data_model_matrix_EB,
    ...
    if grid_EEBBEB:
        ...
        alpha_grid_fisherEEBBEB = np.arange(min_angle, max_angle,
                                            (max_angle - min_angle)/nstep_angle)
        L_EEBBEB = cl_lib.L_gridding(spectra_cl, data_model_matrix, alpha_grid_fisherEEBBEB,
                                     b, nside, f_sky_SAT)[0]
        sigmafisherEEBBEB = cl_lib.error_68(alpha_grid_fisherEEBBEB, L_EEBBEB, rotation_angle.value)
    ...
    if grid_EE:
        ...
        alpha_grid_fisherEE = np.arange(min_angle, max_angle,
                                        (max_angle - min_angle)/nstep_angle)
        L_EE = cl_lib.L_gridding(spectra_cl, data_model_matrix_EE, alpha_grid_fisherEE,
                                 b, nside, f_sky_SAT, 'EE')[0]

        sigma68EE = cl_lib.error_68(alpha_grid_fisherEE, L_EE, rotation_angle.value)
    ...
    if grid_BB:
        ...
        alpha_grid_fisherBB = np.arange(min_angle, max_angle,
                                        (max_angle - min_angle)/nstep_angle)
        L_BB = cl_lib.L_gridding(spectra_cl, data_model_matrix_BB, alpha_grid_fisherBB,
                                 b, nside, f_sky_SAT, 'BB')[0]
        sigma68BB = cl_lib.error_68(alpha_grid_fisherBB, L_BB, rotation_angle.value)
    ...
    if grid_EB:
        ...
        sigma68EB = cl_lib.error_68(alpha_grid_fisherEB, L_EB, rotation_angle.value)
